...
- (void)updateUI
{
    self.colourfulCharactersLabel.text = [NSString stringWithFormat:@"%d colourful characters", [[self charactersWithAttribute:NSForegroundColorAttributeName] length]];
